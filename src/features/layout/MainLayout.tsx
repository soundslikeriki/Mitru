...
export function MainLayout({
  ...
  return (
    <div className={`${resolvedTheme === "dark" ? "dark bg-[#0F172A] text-slate-100" : "light bg-slate-100 text-slate-950"} min-h-screen transition-colors`}>
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <div className="flex min-w-0 flex-1 flex-col md:pl-[280px]">
          <Header />
          <motion.main
            className="flex w-full min-w-0 flex-1 flex-col px-4 py-5 sm:px-6 lg:px-8 lg:py-8"
